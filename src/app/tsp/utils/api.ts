...
import { GraphData, BABTreeInterface, BackTrackingInterface } from '@/types';


export const saveToHistory = async (result: BABTreeInterface | BackTrackingInterface, userEmail: string, visitedNodes: string[], graphData: GraphData ) => {
